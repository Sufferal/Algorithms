...
import a01_recursive, a02_dynamic, a03_matrix_, a03_matrix_optimized, a04_binet, a05_kartik, a06_modulo
...
if __name__ == "__main__":
  ...
  kartik_time_arr = [a05_kartik.get_time_fibonum(i) for i in values]
  ...
  plt.plot(values, kartik_time_arr, color = 'violet', label="Kartik")
